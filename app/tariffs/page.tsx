...
const PriceTable = ({ title, data }: { title: string; data: typeof massageServices }) => (
  <div className="space-y-4">
    <h2 className="text-2xl md:text-3xl font-trajan-pro font-bold text-[#b64a26]">
      {title}
    </h2>
      ...
      <div className="w-full max-w-5xl mx-auto px-2 md:px-4 py-12 md:py-16">
        ...
        <div className="mt-16 pt-12 border-t border-[#e5d5cc]">
          <p className="font-lato text-[#666] text-center text-sm md:text-base leading-relaxed">
            ...
            Contact us at <span className="font-semibold text-[#b64a26]">+212 610 200 040</span> or <span className="font-semibold text-[#b64a26]">+212 610 705 876</span>
          </p>
        </div>
      </div>
    </section>
