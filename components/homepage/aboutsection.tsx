    ...
    >
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto">
          <h2
            className={`discovery-heading text-3xl md:text-4xl lg:text-5xl font-bold mb-6 transition-all duration-1000 ease-out ${
          ...
          <div
            className={`discovery-text space-y-6 transition-all duration-1000 ease-out delay-400 ${
